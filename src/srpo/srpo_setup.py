...
def setup_srpo_training(
    ...
    srpo_config = SRPOConfig(
        ...
        srpo_enable_self_paced_reward=args.srpo_enable_self_paced_reward,
        srpo_self_paced_visual_threshold=args.srpo_self_paced_visual_threshold,
        srpo_self_paced_temporal_threshold=args.srpo_self_paced_temporal_threshold,
        srpo_self_paced_semantic_threshold=args.srpo_self_paced_semantic_threshold,
        srpo_self_paced_softmax_beta=args.srpo_self_paced_softmax_beta,
        srpo_self_paced_sparsity_lambda=args.srpo_self_paced_sparsity_lambda,
        srpo_self_paced_sigmoid_scale=args.srpo_self_paced_sigmoid_scale,
        srpo_self_paced_visual_scale=args.srpo_self_paced_visual_scale,
        srpo_self_paced_temporal_scale=args.srpo_self_paced_temporal_scale,
        srpo_self_paced_semantic_scale=args.srpo_self_paced_semantic_scale,
        srpo_self_paced_enable_advantage_norm=args.srpo_self_paced_enable_advantage_norm,
        srpo_self_paced_advantage_norm_eps=args.srpo_self_paced_advantage_norm_eps,
        srpo_self_paced_use_grpo_clip_objective=args.srpo_self_paced_use_grpo_clip_objective,
        srpo_self_paced_grpo_clip_eps=args.srpo_self_paced_grpo_clip_eps,
        srpo_self_paced_policy_std=args.srpo_self_paced_policy_std,
        srpo_self_paced_apply_discount_to_grpo=args.srpo_self_paced_apply_discount_to_grpo,
        srpo_self_paced_use_lagged_old_policy=args.srpo_self_paced_use_lagged_old_policy,
        srpo_self_paced_old_policy_update_interval=args.srpo_self_paced_old_policy_update_interval,
        srpo_self_paced_old_policy_offload_cpu=args.srpo_self_paced_old_policy_offload_cpu,
        srpo_self_paced_logprob_mode=args.srpo_self_paced_logprob_mode,
        srpo_self_paced_enable_offline_threshold_calibration=args.srpo_self_paced_enable_offline_threshold_calibration,
        srpo_self_paced_offline_calibration_steps=args.srpo_self_paced_offline_calibration_steps,
        srpo_self_paced_offline_calibration_batch_size=args.srpo_self_paced_offline_calibration_batch_size,
        srpo_self_paced_offline_calibration_update_network=args.srpo_self_paced_offline_calibration_update_network,
        srpo_self_paced_enable_prompt_curriculum=args.srpo_self_paced_enable_prompt_curriculum,
        srpo_self_paced_stage1_visual_prompt_suffix=args.srpo_self_paced_stage1_visual_prompt_suffix,
        srpo_self_paced_stage3_semantic_prompt_suffix=args.srpo_self_paced_stage3_semantic_prompt_suffix,
        srpo_self_paced_auto_calibrate_thresholds=args.srpo_self_paced_auto_calibrate_thresholds,
        srpo_self_paced_threshold_calibration_factor=args.srpo_self_paced_threshold_calibration_factor,
        srpo_self_paced_threshold_calibration_warmup_steps=args.srpo_self_paced_threshold_calibration_warmup_steps,
        srpo_self_paced_threshold_calibration_momentum=args.srpo_self_paced_threshold_calibration_momentum,
