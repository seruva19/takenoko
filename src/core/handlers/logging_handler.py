...
def collect_and_log_training_metrics(
    ...
    if getattr(loss_components, "flowc2s_transport_loss", None) is not None:
    ...
    if getattr(loss_components, "flowc2s_transport_similarity", None) is not None:
    ...
    if getattr(loss_components, "flex_loss", None) is not None:
        logs["loss/flex"] = float(loss_components.flex_loss.item())
