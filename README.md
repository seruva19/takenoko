...
| [SimpleTuner](https://github.com/bghira/SimpleTuner) | repo | - Routed TREAD<br>- SOAP optimizer<br>- Masked training (spatial-first loss, area interpolation, proper normalization, auto mask generation)<br>- Advanced EMA features | [bghira](https://github.com/bghira) | AGPL-3.0 | |
